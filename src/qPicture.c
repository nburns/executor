...
char ROMlib_rcsid_qPicture[] =
	    "$Id: qPicture.c 63 2004-12-24 18:19:43Z ctm $";
#endif
...
PUBLIC PicHandle ROMlib_OpenPicture_helper (const Rect *pf,
...
PUBLIC void ROMlib_textpicupdate( Point num, Point den )
{
    updateclip();
    updatefont();
    updatetxface();
...
PUBLIC void ROMlib_drawingpicupdate( void )
{
    updateclip();
    updatepnsize();
    updatepnmode();
...
PUBLIC void ROMlib_drawingverbpicupdate( GrafVerb v )
{
...
PUBLIC void ROMlib_drawingverbrectpicupdate( GrafVerb v, Rect *rp )
{
    piccachehand pch;
...
PUBLIC void ROMlib_drawingverbrectovalpicupdate( GrafVerb v, Rect *rp,
								   Point *ovp )
{
