...
void
ROMlib_CALLTEXT (INTEGER bc, Ptr bufp, Point num, Point den)
{
  QDProcsPtr gp;
...
void
ROMlib_CALLRECT (GrafVerb v, Rect * rp)
{
  QDProcsPtr gp;
...
void
ROMlib_CALLOVAL (GrafVerb v, Rect * rp)
{
  QDProcsPtr gp;
  pascal trap void (*pp) (GrafVerb, Rect *);
...
void
ROMlib_CALLRRECT (GrafVerb v, Rect * rp, INTEGER ow, INTEGER oh)
{
  QDProcsPtr gp;
...
void
ROMlib_CALLARC (GrafVerb v, Rect * rp, INTEGER starta, INTEGER arca)
{
  QDProcsPtr gp;
  pascal trap void (*pp) (GrafVerb, Rect *, INTEGER, INTEGER);
...
void
ROMlib_CALLRGN (GrafVerb v, RgnHandle rh)
{
  QDProcsPtr gp;
...
void
ROMlib_CALLPOLY (GrafVerb v, PolyHandle rh)
{
  QDProcsPtr gp;
...
void
ROMlib_CALLBITS (BitMap * bmp, const Rect *srcrp, const Rect *dstrp,
...
void
ROMlib_CALLCOMMENT (INTEGER kind, INTEGER size, Handle datah)
{
  QDProcsPtr gp;
...
INTEGER
ROMlib_CALLTXMEAS (INTEGER bc, Ptr bufp, Point * nump, Point * denp,
		   FontInfo * fip)
{
  QDProcsPtr gp;
...
void
ROMlib_PICWRITE (Ptr addr, INTEGER count)
{
  QDProcsPtr gp;
