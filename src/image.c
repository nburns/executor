...
pixel_image_t *
image_init (pixel_image_desc_t *image_desc)
{
...
void
image_copy (pixel_image_t *image, int color_p /* visual */,
...
void
image_validate_x_bits (pixel_image_t *image, int color_p /* visual */)
{
  GDHandle gdev;
...
/* assumes color */
void
image_update_ctab (pixel_image_t *image, const RGBColor *new_colors,
		   int max_color)
{
  PixMapHandle bits;
  CTabHandle bits_ctab;
