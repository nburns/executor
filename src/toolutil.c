...
PUBLIC StringHandle ROMlib_phoney_name_string;
...
void
unpack_int16_bits (HIDDEN_Ptr *sp, HIDDEN_Ptr *dp, INTEGER len)
{
...
PRIVATE Fixed sloptab[46] = {
    0x80000001, 0x00394a30, 0x001ca2d7, 0x001314bd, 0x000e4cf5,
...
{
    int sign, recip;
    auto Fixed retval;	/* cc -a problems */
