...
P 2 (PUBLIC pascal trap, void, ModalDialog, ProcPtr, fp,		/* IMI-415 */
    INTEGER *, item)
{
  /*
...
boolean_t
get_item_style_info (DialogPtr dp, int item_no,
...
void
ROMlib_drawiptext (DialogPtr dp, itmp ip, int item_no)
{
...
void
dialog_draw_item (DialogPtr dp, itmp itemp, int itemno)
{
