...
char ROMlib_rcsid_fileInfo[] =
	    "$Id: fileInfo.c 86 2005-05-25 00:47:12Z ctm $";
#endif
							    ...
							    FInfo *, fndrinfo)
{
    ...
    pbr.fileParam.ioFlFndrInfo.fdFldr     = fndrinfo->fdFldr =
					     pbr.fileParam.ioFlFndrInfo.fdFldr;
...
PUBLIC Byte
open_attrib_bits (LONGINT file_id, VCB *vcbp, INTEGER *refnump)
{
  Byte retval;
  int i;
