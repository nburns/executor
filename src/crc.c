...
char ROMlib_rcsid_crc[] =
	    "$Id: crc.c 63 2004-12-24 18:19:43Z ctm $";
#endif
...
PUBLIC unsigned short ROMlib_crcccitt(unsigned char *data, long length)
{
    unsigned long l;
...
short getthecrc(ResType typ, long id)
{
    Handle h;
