...
typedef enum { GetOp, SetOp, LockOp, UnlockOp } changeop;
...
PUBLIC OSErr hfsPBGetFInfo(ParmBlkPtr pb, BOOLEAN async)
{
    return PBFInfoHelper(GetOp, (fileParam *) pb, 0L, async);
}

PUBLIC OSErr hfsPBHGetFInfo(HParmBlkPtr pb, BOOLEAN async)
{
    return PBFInfoHelper(GetOp, (fileParam *) pb, CL(pb->fileParam.ioDirID), async);
}

PUBLIC OSErr hfsPBSetFInfo(ParmBlkPtr pb, BOOLEAN async)
{
    return PBFInfoHelper(SetOp, (fileParam *) pb, 0L, async);
}

PUBLIC OSErr hfsPBHSetFInfo(HParmBlkPtr pb, BOOLEAN async)
{
    return PBFInfoHelper(SetOp, (fileParam *) pb, CL(pb->fileParam.ioDirID), async);
}

PUBLIC OSErr hfsPBSetFLock(ParmBlkPtr pb, BOOLEAN async)
{
    return PBFInfoHelper(LockOp, (fileParam *) pb, 0L, async);
}

PUBLIC OSErr hfsPBHSetFLock(HParmBlkPtr pb, BOOLEAN async)
{
    return PBFInfoHelper(LockOp, (fileParam *) pb, CL(pb->fileParam.ioDirID), async);
}

PUBLIC OSErr hfsPBRstFLock(ParmBlkPtr pb, BOOLEAN async)
{
    return PBFInfoHelper(UnlockOp, (fileParam *) pb, 0L, async);
}

PUBLIC OSErr hfsPBHRstFLock(HParmBlkPtr pb, BOOLEAN async)
{
    return PBFInfoHelper(UnlockOp, (fileParam *) pb,
			 CL (pb->fileParam.ioDirID), async);
}

PUBLIC OSErr hfsPBSetFVers(ParmBlkPtr pb, BOOLEAN async)
{
...
PUBLIC OSErr hfsPBRename(ParmBlkPtr pb, BOOLEAN async)
{
    return renamehelper((ioParam *) pb, async, 0L, regular);
}

PUBLIC OSErr hfsPBHRename(HParmBlkPtr pb, BOOLEAN async)
{
