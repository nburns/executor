...
# define TheZone           GET_TheZone()
# define SysZone           GET_SysZone()
# define ApplZone          GET_ApplZone()
# define MemTop            GET_MemTop()
# define BufPtr            GET_BufPtr()
# define HeapEnd           GET_HeapEnd()
# define ApplLimit         GET_ApplLimit()
# define ROMBase           GET_ROMBase()
# define heapcheck         GET_heapcheck()
# define GZRootHnd         GET_GZRootHnd()
# define IAZNotify         GET_IAZNotify()
# define CurrentA5         GET_CurrentA5()
# define CurStackBase      GET_CurStackBase()
# define GET_TheZone()     ((THz) PPR(TheZone_H))
# define SET_TheZone(v)    (TheZone_H.pp = RPP(v))
# define GET_SysZone()     ((THz) PPR(SysZone_H))
# define SET_SysZone(v)    (SysZone_H.pp = RPP(v))
# define GET_ApplZone()    ((THz) PPR(ApplZone_H))
# define SET_ApplZone(v)   (ApplZone_H.pp = RPP(v))
# define GET_MemTop()      ((Ptr) PPR(MemTop_H))
# define SET_MemTop(v)     (MemTop_H.pp = RPP(v))
# define GET_BufPtr()      ((Ptr) PPR(BufPtr_H))
# define SET_BufPtr(v)     (BufPtr_H.pp = RPP(v))
# define GET_HeapEnd()     ((Ptr) PPR(HeapEnd_H))
# define SET_HeapEnd(v)    (HeapEnd_H.pp = RPP(v))
# define GET_ApplLimit()   ((Ptr) PPR(ApplLimit_H))
# define SET_ApplLimit(v)  (ApplLimit_H.pp = RPP(v))
# define GET_ROMBase()     ((Ptr) PPR(ROMBase_H))
# define SET_ROMBase(v)    (ROMBase_H.pp = RPP(v))
# define GET_heapcheck()   ((Ptr) PPR(heapcheck_H))
# define SET_heapcheck(v)  (heapcheck_H.pp = RPP(v))
# define GET_GZRootHnd()   ((Handle) PPR(GZRootHnd_H))
# define SET_GZRootHnd(v)  (GZRootHnd_H.pp = RPP(v))
# define GET_IAZNotify()   ((ProcPtr) PPR(IAZNotify_H))
# define SET_IAZNotify(v)  (IAZNotify_H.pp = RPP(v))
# define GET_CurrentA5()   ((Ptr) PPR(CurrentA5_H))
# define SET_CurrentA5(v)  (CurrentA5_H.pp = RPP(v))
# define GET_CurStackBase() ((Ptr) PPR(CurStackBase_H))
# define SET_CurStackBase(v) (CurStackBase_H.pp = RPP(v))
#endif
