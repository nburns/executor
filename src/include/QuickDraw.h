...
# define GET_ScrnBase()     (MR(ScrnBase_H.p))
# define SET_ScrnBase(v)    (ScrnBase_H.p = RM(v))
# define Key1Trans     (Key1Trans_H.p)
# define Key2Trans     (Key2Trans_H.p)
# define GET_JCrsrTask()    (MR(JCrsrTask_H.p))
# define SET_JCrsrTask(v)   (JCrsrTask_H.p = RM(v))
#else
# define GET_JInitCrsr()    ((ProcPtr) PPR(JInitCrsr_H))
# define GET_JHideCursor()  ((ProcPtr) PPR(JHideCursor_H))
# define GET_JShowCursor()  ((ProcPtr) PPR(JShowCursor_H))
# define GET_JShieldCursor() ((ProcPtr) PPR(JShieldCursor_H))
# define GET_JSetCrsr()     ((ProcPtr) PPR(JSetCrsr_H))
# define GET_JCrsrObscure() ((ProcPtr) PPR(JCrsrObscure_H))
# define GET_JUnknown574()  ((ProcPtr) PPR(JUnknown574_H))
# define GET_JCrsrTask()    ((ProcPtr) PPR(JCrsrTask_H))
# define SET_JCrsrTask(v)   (JCrsrTask_H.pp = RPP(v))
# define GET_ScrnBase()     ((Ptr) PPR(ScrnBase_H))
# define SET_ScrnBase(v)    (ScrnBase_H.pp = RPP(v))
# define GET_Key1Trans()    ((Ptr) PPR(Key1Trans_H))
# define GET_Key2Trans()    ((Ptr) PPR(Key2Trans_H))
# define JInitCrsr     GET_JInitCrsr()
# define JHideCursor   GET_JHideCursor()
# define JShowCursor   GET_JShowCursor()
# define JShieldCursor GET_JShieldCursor()
# define JSetCrsr      GET_JSetCrsr()
# define JCrsrObscure  GET_JCrsrObscure()
# define JUnknown574   GET_JUnknown574()
# define JCrsrTask     GET_JCrsrTask()
# define ScrnBase      GET_ScrnBase()
# define Key1Trans     GET_Key1Trans()
# define Key2Trans     GET_Key2Trans()
#endif
