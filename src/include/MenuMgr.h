...
# define GET_MenuList()     (MR(MenuList_H.p))
# define SET_MenuList(v)    (MenuList_H.p = RM(v))
# define GET_MBarHook()     (MR(MBarHook_H.p))
# define SET_MBarHook(v)    (MBarHook_H.p = RM(v))
# define GET_MenuHook()     (MR(MenuHook_H.p))
# define SET_MenuHook(v)    (MenuHook_H.p = RM(v))
# define GET_MBDFHndl()     (MR(MBDFHndl_H.p))
# define SET_MBDFHndl(v)    (MBDFHndl_H.p = RM(v))
# define GET_MBSaveLoc()    (MR(MBSaveLoc_H.p))
# define SET_MBSaveLoc(v)   (MBSaveLoc_H.p = RM(v))
# define GET_MenuCInfo()    (MR(MenuCInfo_H.p))
...
# define SET_MBarHook(v)    (MBarHook_H.pp = RPP(v))
# define GET_MenuHook()     ((ProcPtr) PPR(MenuHook_H))
# define SET_MenuHook(v)    (MenuHook_H.pp = RPP(v))
# define GET_MBDFHndl()     ((Handle) PPR(MBDFHndl_H))
# define SET_MBDFHndl(v)    (MBDFHndl_H.pp = RPP(v))
# define GET_MBSaveLoc()    ((Handle) PPR(MBSaveLoc_H))
...
# define MenuList           GET_MenuList()
# define MBarHook           GET_MBarHook()
# define MenuHook           GET_MenuHook()
# define MBDFHndl           GET_MBDFHndl()
# define MBSaveLoc          GET_MBSaveLoc()
# define MenuCInfo          GET_MenuCInfo()
#endif
